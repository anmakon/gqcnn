...
plt.close()
binwidth = 0.001
plt.hist(grasp_dist_table, range=(0, 0.06),
         bins=np.arange(min(grasp_dist_table), max(grasp_dist_table) + binwidth, binwidth))
plt.xlim(0, 0.06)
plt.ylim(0, ymax)
...
plt.close()
plt.hist(grasp_dist_max, range=(-0.01, 0.05),
         bins=np.arange(min(grasp_dist_max), max(grasp_dist_max) + binwidth, binwidth))
plt.xlim(-0.01, 0.05)
plt.ylim(0, ymax)
...
plt.close()
plt.hist(grasp_dist_cent, range=(-0.04, 0.02),
         bins=np.arange(min(grasp_dist_cent), max(grasp_dist_cent) + binwidth, binwidth))
plt.xlim(-0.04, 0.02)
plt.ylim(0, ymax)
